  ...
  Color get color {
    switch (this) {
      ...
      case ButtonArea1.per:
        return Color.fromARGB(255, 234, 122, 89).withOpacity(0.78);
      ...
      case ButtonArea1.calculate:
        return Color.fromARGB(255, 238, 165, 19).withOpacity(0.58);
      case ButtonArea1.dot:
      case ButtonArea1.notation:
        return Color.fromARGB(255, 215, 150, 81); // Add color for dot and notation cases
